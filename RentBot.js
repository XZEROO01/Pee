...
auth: state,
browser: [`Xyny bot By ${ownername}`, "Chrome", "1.0.0"],
...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '6282140506913@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
sendMessage(`6282140506913@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"businessOwnerJid": `6282140506913@s.whatsapp.net`
}
}, options)
